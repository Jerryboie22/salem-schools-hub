        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm opacity-95">
              Building a generation rooted in knowledge, discipline, and
              excellence. Quality education from nursery to secondary level.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs md:text-sm">
              <li className="flex items-start gap-2 opacity-95">
                ...
                <span>
                  No. 17 Bolanle Awosika Street, Off Ilogbo Road, Ojuore, Ota,
                  Ogun State
                </span>
              </li>
